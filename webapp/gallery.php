...
<div id="page">
  ...
  <div class="cont_round_center">
    ...
    <div class="content">
      <div class="midarea">
        <h2 class="intitle"> <span class="title">Gallery</span> <span class="title_text">View the images below and feel free to share the images below on Twitter or Facebook</span> </h2>
        <ul class="intercont">
          <li>
            <ul>
